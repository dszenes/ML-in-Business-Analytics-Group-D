...
As said in the last section, we transformed our "shares" variable firstly into a categorical one with two levels. Two of the levels we created unpopular (<quantile 0.5) and popular(>quantile 0.5) represent 100% of the shares, and in this graphical representation, we see that we mostly have even numbers for these levels, but with a slight advantage for the unpopular one. It's going to be interesting to see what type of content doesn't get optimal shares and which one does.
