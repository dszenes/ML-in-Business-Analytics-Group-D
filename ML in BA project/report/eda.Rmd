...
```{r}
ggplot(data = final_df, aes(data_channel, log(shares))) + geom_boxplot()
```

```{r}
ggplot(data = final_df, aes(day, log(shares))) + geom_boxplot()
```

```{r}
ggplot(data = final_df, aes(day_is_weekend, log(shares))) + geom_boxplot()
```
