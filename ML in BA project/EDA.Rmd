...
df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_monday), fill= "red")

df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_tuesday), fill= "red")

df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_wednesday), fill= "red")

df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_thursday), fill= "red")

df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_friday), fill= "red")

df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_saturday), fill= "red")

df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_sunday), fill= "red")

df_bi%>%
  ggplot()+
geom_bar(mapping = aes( x = day_is_weekend), fill= "red")

df_bi%>% ggplot(aes(x = LDA_00)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi%>% ggplot(aes(x = LDA_00)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM

df_bi %>% ggplot(aes(x = LDA_01)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = LDA_01)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM

df_bi %>% ggplot(aes(x = LDA_02)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = LDA_02)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM

df_bi %>% ggplot(aes(x = LDA_03)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = LDA_03)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM

df_bi %>% ggplot(aes(x = LDA_04)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = LDA_04)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM


#Rate of positive and negative words in the content
df_bi %>% ggplot(aes(x = global_rate_positive_words)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = global_rate_positive_words)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM

df_bi %>% ggplot(aes(x = global_rate_negative_words)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = global_rate_negative_words)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM

#polarity and subjectivity in the text
df_bi %>% ggplot(aes(x = global_subjectivity)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = global_subjectivity)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM

df_bi %>% ggplot(aes(x = global_sentiment_polarity)) +
  geom_boxplot(color = "black", fill = "grey")#BOXPLOT
df_bi %>% ggplot(aes(x = global_sentiment_polarity)) +
  geom_histogram(color = "black", fill = "grey")#HISTOGRAM
